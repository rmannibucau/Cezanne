...
namespace Cezanne.Core.Tests.Cli
{
    public class CezanneTests : ITempFolder
    {
        ...
        public void Inspect()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(
                    """
                    [   info][      Cezanne.Core.Service.RecipeHandler] Inspecting 'test'
                    Inspection Result
                    └── test
                        └── Descriptors
                            └── descriptor.yaml
        ...
        private CezanneStandalone _Cezanne(string baseDir, WebApplication? mockServer = null)
        {
            return new CezanneStandalone
            {
