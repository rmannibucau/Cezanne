    ...
    public class ConditionJsonEvaluator(ILogger<ConditionJsonEvaluator> logger)
    {
        ...
        private bool _Evaluate(Manifest.JsonPointerOperator type, string value, string evaluated)
        {
            return type switch
            {
                ...
                Manifest.JsonPointerOperator.EqualsIgnoreCase => string.Equals(evaluated, value,
                    StringComparison.OrdinalIgnoreCase),
                Manifest.JsonPointerOperator.NotEqualsIgnoreCase => !string.Equals(evaluated, value,
                    StringComparison.OrdinalIgnoreCase),
